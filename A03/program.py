...
def panorama(img1, img2):
    ...
    cv2.imwrite("output/image1_t.jpg", img1_t)
    img2_t = cv2.warpPerspective(img2, T, (int(maxx - minx), int(maxy - miny)))
    cv2.imwrite("output/image2_t.jpg", img2_t)
...
img1ori = cv2.imread("input/image1.png")
img2ori = cv2.imread("input/image2.png")
img3ori = cv2.imread("input/image3.png")
img1ori = img1ori[::5, ::5]
img2ori = img2ori[::5, ::5]
img3ori = img3ori[::5, ::5]
...
pan1 = panorama(img1, img2)
pan2 = panorama(img2,img3)
pan3 = panorama(pan1,pan2)


cv2.imwrite("output/image3.png", pan3)
